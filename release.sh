...
# Release script for blueline following git flow workflow
...
./target/release/blueline GET https://www.swapi.tech/api/people/1 | jq -r .message > /tmp/blueline_test_output
EXPECTED='ok'
ACTUAL=$(cat /tmp/blueline_test_output)
...
./target/release/blueline --help > /dev/null
...
print_status "https://github.com/samwisely75/blueline/actions"
