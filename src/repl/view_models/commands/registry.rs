...
impl UnifiedCommandRegistry {
    ...
    pub fn get_all_commands(&self) -> &[Arc<dyn Command>] {
        &self.commands
    }
...
mod tests {
    ...
    fn unified_registry_should_create_with_default_commands() {
        ...
        assert!(has_yank_command, "Registry should contain YankSelectionCommand");
    }
    ...
    fn unified_registry_should_return_none_for_irrelevant_input() {
        ...
        assert!(result.is_none(), "Should find no relevant command for 'y' in Normal mode");
    }
    ...
    fn unified_registry_should_allow_adding_custom_commands() {
        ...
        registry.add_command(Arc::new(TestCommand::default()));
