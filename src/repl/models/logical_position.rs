//! # Logical Position Types
//!
//! Text coordinate types for logical positions and ranges in documents.
//! These types represent positions in text content using line/column coordinates.
