...
6. Run `cargo clippy --all-targets --all-features -- -D warnings` to make sure there are no warnings
7. Run `cargo fmt` to format the code
8. Notify the master about the changes and ask for review
